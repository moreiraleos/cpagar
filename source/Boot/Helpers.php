...
function str_textarea(string $text): string
{
    ...
    $arraReplace = ["&#10;", "&#10;&#10;", "&#10;&#10;&#10;", "&#10;&#10;&#10;&#10;", "&#10;&#10;&#10;&#10;&#10;"];
    return "<p>" . str_replace($arraReplace, "</p><p>", $text) . "</p>";
}
 ...
 * @return string
 */
function theme(string $path = NULL, string $theme = CONF_VIEW_THEME)
{
    if ($_SERVER['HTTP_HOST'] == 'localhost') {
...
function date_fmt_back(?string $date): ?string
{
    ...
    if (strpos($date, " ")) {
        ...
        //  20/10/2019 => 20 - 10 -2019 => 2019-10-20
    }

    return implode("-", array_reverse(explode("/", $date)));
    // 10/10/2019 => 2019-10-10
}
